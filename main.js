...
import { ref, onValue, update, remove } from 'https://www.gstatic.com/firebasejs/9.1.3/firebase-database.js';
...
function exibirPedidoSugerido(pedido) {
  ...
  Object.keys(pedido).forEach(team => {
    Object.keys(pedido[team]).forEach(variation => {
      ...
      document.getElementById('pedidoContainer').insertAdjacentHTML('beforeend', pedidoTexto);
    });
  });
          ...
          Object.keys(products).forEach(productId => {
            ...
            const row = `
              <tr>
                ...
                <td class="border px-4 py-2 flex justify-between"> <!-- Adicionando ações -->
